...
namespace GameRig.Scripts.Systems.UpgradesSystem
{
	...
	public class UpgradeSettings : ScriptableObject
	{
		...
		/// </summary>
		public string UpgradeSaveKey => upgradeSaveKey;

		/// <summary>
		/// Gets the current upgrade values settings
		/// </summary>
		public UpgradeValueSettings[] UpgradeValueProgressions => valueProgressions;
		...
		public UpgradePriceSettings PriceSettings => priceSettings;
