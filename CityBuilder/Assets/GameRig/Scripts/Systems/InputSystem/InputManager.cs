...
namespace GameRig.Scripts.Systems.InputSystem
{
	...
	public static class InputManager
	{
		...
		public static void Subscribe(KeyEventType type, KeyCode keyCode, Action subscriberAction)
		{
		...
		/// </summary>
		/// <remarks>
		/// This method returns values from -100 to 100 which means
		/// -100 - the touch moved from right/top margin to left/bottom margin in one frame and
		/// 100 - the touch moved from left/bottom margin to right/top margin in one frame
		/// </remarks>
		...
		{
			return currentAxesInput - previousAxesInput;
		}
		...
		/// </summary>
		/// <remarks>
		/// This method returns values from 0 to 100 which means 0 - the left/bottom margins and 100 - right/top margins
		/// </remarks>
		...
		{
			IEnumerable<KeyEventType> inputEventTypes = Enum.GetValues(typeof(KeyEventType)).Cast<KeyEventType>();
