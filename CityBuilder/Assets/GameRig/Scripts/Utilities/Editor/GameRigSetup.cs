...
namespace GameRig.Scripts.Utilities.Editor
{
	...
	public static class GameRigSetup
	{
		private const string FilesPaths =
			"Art,Art/Animations,Art/Animations/Animation Clips,Art/Animations/Animators,Art/Fonts,Art/Materials,Art/Models,Art/Shaders,Art/Sprites,Art/Sprites/Game,Art/Sprites/UI,Art/Textures,Art/VFX,Prefabs,Presets,Resources,Scenes,Scripts,Scripts/Game,Scripts/UI";
		...
		public static void SetupAssetsFolders()
		{
			...
			string projectName = "_" + splittedDataPath[splittedDataPath.Length - 2].Replace('_', ' ');
